...
WORKDIR /src
COPY ["Docker/DockerSample/DockerSample.csproj", "Docker/DockerSample/"]
RUN dotnet restore "Docker/DockerSample/DockerSample.csproj"
COPY . .
WORKDIR "/src/Docker/DockerSample"
